...
<template>
  <div v-if="userPermissions.canAddTeamMembers">
    <!-- Add Team Member -->
    <VFormSection @submitted="addTeamMember">
      ...
      <template #content>
        ...
        <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
          <VFormLabel text="Role" />
          <VFormErrors :message="addTeamMemberForm.errors.role" class="mt-2" />
      ...
      <template #actions>
        <VActionMessage :on="addTeamMemberForm.recentlySuccessful" class="mr-3"> Added. </VActionMessage>

        <VButton :class="{ 'opacity-25': addTeamMemberForm.processing }" :disabled="addTeamMemberForm.processing">
          Add
        </VButton>
      </template>
    </VFormSection>
  ...
  <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
    ...
    <VFormSection class="mt-10 sm:mt-0">
