<template>
  ...
  <VNotification :notification="{}"></VNotification>
  <VCard>
    <VText>
      <p class="text-lg">Until now, trying to style an article, document, or blog post with Tailwind has been a tedious task that required a keen eye for typography and a lot of complex custom CSS.</p>
  ...
  <VButton variant="secondary">Button</VButton>
  <VButton variant="danger">Button</VButton>
  <VFormInput label="Label"></VFormInput>
  <VFormCheckbox label="Label"></VFormCheckbox>
  <VFormSelect label="Label">
    <option>option 1</option>
    <option>option 2</option>
    <option>option 3</option>
  </VFormSelect>
  <VFormList :options="[{ title: 'test 1' }, { title: 'test 2'}, { title: 'test 3' }, { title: 'test 4' }]" v-slot="{ item }">
